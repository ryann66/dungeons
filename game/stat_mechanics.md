# Stat Mechanics
## Speed
Speed is the speed at which the unit walks.

## Damage
Damage is the amount of health removed from any units hit.
...
## Regen
Regen is health gained/lost per second.

## Duration
Duration is the number of seconds that an effect will last for